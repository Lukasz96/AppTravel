...
@Database(version = 1, entities = {Podroz.class, Notatka.class, ElementListyDoSpakowania.class, Kategoria.class, ListaDoSpakowania.class})
                ...
                .addCallback(new Callback() {
                    ...
                    public void onCreate(@NonNull SupportSQLiteDatabase db) {
                        ...
                        Executors.newSingleThreadScheduledExecutor().execute(new Runnable() {
                            @Override
                            public void run() {
                                getInstance(context).kategoriaDao().insertKategorie(dataGenerator.populateData());
                            }
                        });
                    }
                })
