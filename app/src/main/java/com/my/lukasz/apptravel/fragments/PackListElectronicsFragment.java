...
public class PackListElectronicsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate(R.layout.packlistelectronicsfragmentlayout,container,false);
        packListId=getArguments().getLong("bundlePackListId");
        mDb= AppDatabase.getInstance(getContext());
        long categoryId=mDb.kategoriaDao().getIdKategoriiOdNazwy(getString(R.string.tabelectroinicslabel));
        ...
        listView=view.findViewById(R.id.listviewfragmentelectronicstopack);
